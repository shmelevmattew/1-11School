Cannot POST /api/admin/gallery-upload# Сервер заявок для сайта "Школа 1-11"
...
4. Настройте переменные окружения в файле .env:
  ...
  - `ADMIN_PANEL_PATH` - секретный путь админ-панели (например `/admin-z7p4k9x`)
...
- Страница админ-панели: значение из `ADMIN_PANEL_PATH`
- Вход выполняется по `ADMIN_PASSWORD`
- После входа можно менять базовый контент первого экрана и футера
- Можно загружать фотографии в карусель галереи (JPG/PNG/WEBP)
- Изменения сохраняются в `server/data/site-content.json`
